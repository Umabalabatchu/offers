...
//           {/* <Route path="/" element={<Streams></Streams>}></Route> */}
//           <Route path="/" element={<Stream></Stream>}></Route>
//           <Route path="/" element={<Events></Events>}></Route>
//           <Route path="/" element={<Stream></Stream>}></Route>
//           <Route path="/" element={<Plays></Plays>}></Route>
//           <Route path="/" element={<Sports></Sports>}></Route>
//           <Route path="/" element={<Activities></Activities>}></Route>
//           <Route path="/" element={<Buzz></Buzz>}></Route>
//           <Route path="/" element={<ListYourShow></ListYourShow>}></Route>
//           <Route path="/" element={<Corporates></Corporates>}></Route>
//           <Route path="/" element={<Offers></Offers>}></Route>
//           <Route path="/" element={<Gift_Cards></Gift_Cards>}></Route>
